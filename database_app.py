...
if __name__ == '__main__':
    ...
    try:
        ...
        if cur.fetchone()[0] == 1: #is police
            while True:
                os.system('clear')
                print("""We support following features:
    ...
    Please select a feature to run (1-6) or type anything else to quit:""")
            ...
            while True:
                ...
                print("""We support following features:
1. List neighborhoods where the number of events is greater than or equal to a specified threshold.
2. List automobile minimum and maximum price and total vehicle of all communities, ranked by average price of vehicles that got stolen.
3. Check the latest events captured in the dataset based on input.

Please select a feature to run (1-3) or type anything else to quit:""")
                feature = input()
